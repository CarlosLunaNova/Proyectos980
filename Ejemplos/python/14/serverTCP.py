...
IP_ADDR = socket.gethostname() #La IP donde desea levantarse el server
IP_PORT = 9800 #Puerto al que deben conectarse los clientes

BUFFER_SIZE = 1024 #Bloques de 16 KB

# Bind the socket to the port
serverAddress = (IP_ADDR, IP_PORT) #Escucha en todas las interfaces
